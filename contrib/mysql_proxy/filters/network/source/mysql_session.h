...
public:
  ...
  uint8_t convertToSeqOnReciever(uint8_t seq, bool is_upstream) { return seq - (is_upstream ? 1 : -1) * seq_offset_; }
  void resetSeq() { seq_ = MYSQL_REQUEST_PKT_NUM; seq_offset_ = 0; }
  void incSeq() { seq_++; }
